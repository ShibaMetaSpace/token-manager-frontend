...
const LandingFeatures = props => {
  const { chain, viewHeight, scroll } = props
  const classes = useStyles()

  const [check, setCheck] = useState(false)

  useEffect(() => {
    if (viewHeight !== null & (scroll - viewHeight) > 750) {
      setCheck(true)
    }
  }, [scroll, viewHeight])
    ...
    <div className={classes.section}>
      <Container maxWidth="lg">
        <Fade
          ...
          timeout={3000}
        >
          <div className={clsx(classes.sectionTitle, classes.center)}>
            Features
          </div>
        </Fade>
        <Grid container spacing={2}>
          ...
          <Grid item xs={4}>
            <Fade
              in={check}
              timeout={chain === 'ethereum' ? 1400 : 1300}
            >
              <Paper className={classes.featureItem}>
                <div className={classes.featureTitle}>
                  <div className={classes.featureIcon}>
          ...
          <Grid item xs={4}>
            <Fade
              in={check}
              timeout={chain === 'ethereum' ? 1500 : 1400}
            >
              <Paper className={classes.featureItem}>
                <div className={classes.featureTitle}>
                  <div className={classes.featureIcon}>
          ...
          <Grid item xs={4}>
            <Fade
              in={check}
              timeout={chain === 'ethereum' ? 1600 : 1500}
            >
              <Paper className={classes.featureItem}>
                <div className={classes.featureTitle}>
                  <div className={classes.featureIcon}>
          ...
          <Grid item xs={4}>
            <Fade
              in={check}
              timeout={chain === 'ethereum' ? 1800 : 1700}
            >
              <Paper className={classes.featureItem}>
                <div className={classes.featureTitle}>
                  <div className={classes.featureIcon}>
